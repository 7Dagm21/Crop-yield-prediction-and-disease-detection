...
DISEASE_MODEL_URL = "https://github.com/7Dagm21/Crop-yield-prediction-and-disease-detection/releases/download/v1.0.0/resnet18_disease_model.pth"  # Set to a public URL to enable runtime download (leave empty to disable)
YIELD_MODEL_URL = "https://github.com/7Dagm21/Crop-yield-prediction-and-disease-detection/releases/download/v1.0.0/yield_model.pth"
YIELD_REGRESSION_MODEL_URL = "https://github.com/7Dagm21/Crop-yield-prediction-and-disease-detection/releases/download/v1.0.0/yield_regression_model.pth"
